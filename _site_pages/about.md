...
<!--
  Your full narrative goes here as plain Markdown paragraphs — this is
  the longer story that doesn't fit on the one-screen Home page: your
  path into the field, what drives your research, how the different
  strands of your work (academic research, sensory judging, science
  communication) connect.

  To add an editorial pull-quote anywhere in this text, start a line
  with ">", for example:

  > Perception is not a passive recording of the world — it is an act
  > of construction.
